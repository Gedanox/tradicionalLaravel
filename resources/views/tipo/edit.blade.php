...
<div>
    @if ($errors->any())
        <div class="alert alert-danger">
            The product type has not been saved, please correct the errors.
        </div>
        @error('update')
    ...
    <form action="{{ url('tipo/' . $tipo->id) }}" method="post">
        ...
        <div class="form-group">
            ...
            <input value="{{ old('descripcion', $tipo->descripcion) }}" type="text" class="form-control" id="descripcion" name="descripcion" placeholder="Type description">
            @error('descripcion')
                <div class="alert alert-danger">{{ $message }}</div>
            @enderror
        </div>
